...
for prefix in 04256520 04379243 02958343 03001627
do
# set -x 
find ~/Dataset/ShapeNetCore.v2/$prefix \
-name *.obj -print0 | xargs -0 -n1 -P1 -I {} \
  blender --background --python shapenet_spherical_renderer.py \
   -- --output_dir ../ShapeNetRender/test/$prefix --mesh_fpath {} --num_observations 50 \
   --sphere_radius 1 --mode=test
done
